...
- **비교 방식**: Vector(chroma db embedding vs mongo DB vector search)
- Keyword(chroma db bm25 vs mongo db keyword search
- hybrid(chroma db vector + bm25 score search vs mongo db hybrid rank fusion search)
